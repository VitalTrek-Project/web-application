...
const monitoringRoutes = [
    ...
    {   path: 'alerts/new',         name: 'monitoring-alert-new',    component: signForm, meta: {title: 'New Alert'}},
    {   path: 'alerts/:id/edit',    name: 'monitoring-alert-edit',   component: signForm, meta: {title: 'Edit Alert'}},
];
