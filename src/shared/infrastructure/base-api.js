...
const platformApi = String(
  import.meta.env.VITE_API_BASE_URL ??
    import.meta.env.VITE_VITALTREK_PLATFORM_API_URL ??
    ""
).trim();
...
export class BaseApi {
  ...
  constructor() {
    if (!platformApi) {
      console.warn(
        "BaseApi: API base URL not configured (VITE_API_BASE_URL or VITE_VITALTREK_PLATFORM_API_URL). Requests may fail."
      );
    }
